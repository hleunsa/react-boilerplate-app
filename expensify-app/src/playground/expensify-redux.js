...
// SORT_BY_AMOUNT
const sortByAmout = () => ({ type: 'SORT_BY_AMOUNT' });
...
store.subscribe(() => {
    ...
    const visibleEpenses = getVisibleExpenses(expenses, filters);
...
store.dispatch(setFilterStartDate(123));
store.dispatch(setFilterEndDate(4754));
